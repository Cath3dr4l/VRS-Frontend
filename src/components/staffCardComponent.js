...
return (
    <Link to={`/management/movie/${item._id}`} style={{ textDecoration: "none"}}>
        <Card className="w-screen h-[240px] my-[5px] flow-root bg-white/30 rounded-md">
            <div className="float-left w-[60%]">
                <Card.Img className="mx-[5px] my-[5px] h-[190px] w-[150px] object-cover overflow-hidden"
                    variant="top"
                    src={item.poster_url}
                    alt="Poster"
                />
                <Card.Title className="text-white font-semibold text-xl mx-2"
                    style={{
                        textAlign: "left",
